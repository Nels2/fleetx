...
type Datastore interface {
	...
	QueriesPerHost(ctx context.Context, hostID uint, teamID *uint) ([]uint, error)
	...
	RebuildVulnerabilitySuppressionMatches(ctx context.Context, ruleID uint) error
	ListPendingVulnerabilitySuppressionRuleIDs(ctx context.Context) ([]uint, error)
